package com.example.asrandroidclient.file
...
object FileUtil {
    ...
    fun getLogCacheDir(ctx: Context = MyApp.CONTEXT): String {
    ...
    fun getAudioCacheDir(ctx: Context = MyApp.CONTEXT): String {
        val fileDir = ctx.getExternalFilesDir(Environment.DIRECTORY_MUSIC) ?: return " "
        return fileDir.parent
    }

    fun getAlarmCacheDir(ctx: Context = MyApp.CONTEXT): String {
